...
public final class Transaction implements Model {
  ...
  private final @ModelField(targetType="Int", isRequired = true) Integer accountNo;
  private final @ModelField(targetType="Int", isRequired = true) Integer categoryNo;
  ...
  public interface AmountStep {
    AccountNoStep amount(Double amount);
  }
  

  public interface AccountNoStep {
    CategoryNoStep accountNo(Integer accountNo);
  }
  

  public interface CategoryNoStep {
  ...
  public static class Builder implements DateStep, AmountPrefixStep, AmountStep, AccountNoStep, CategoryNoStep, BuildStep {
    private String id;
    ...
    @Override
     public AccountNoStep amount(Double amount) {
    ...
    @Override
     public CategoryNoStep accountNo(Integer accountNo) {
    ...
    @Override
     public BuildStep categoryNo(Integer categoryNo) {
        Objects.requireNonNull(categoryNo);
        this.categoryNo = categoryNo;
        return this;
    }
